    ...
    <div>
      <a-row :gutter="24">
        <a-col :xl="16" :lg="24" :md="24" :sm="24" :xs="24">
          <a-card :bordered="false" title="gy Cloud">
            ...
            <p><strong>gy Cloud</strong> 承诺永久开源，不会出商业版之类的东西</p>
            <p><strong>gy Cloud</strong> 是采用 MIT 许可的开源项目，使用完全免费。 但为了项目能够健康持续的发展下去，我们期望获得相应的资金支持。 你可以通过下列的方法来赞助我们的开发。</p>
            <ul>
              <li><h3>一次性赞助</h3></li>
