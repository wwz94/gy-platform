...
import com.gy.common.core.domain.BaseEntity;
import com.gy.common.redis.util.RedisUtils;
...
public class DataScopeAspect
{
    ...
    // 配置织入点
    @Pointcut("@annotation(com.gy.common.annotation.DataScope)")
