package com.gy.common.log.aspect;
...
import com.gy.common.log.annotation.OperLog;
import com.gy.common.log.enums.BusinessStatus;
import com.gy.common.log.event.SysOperLogEvent;
import com.gy.common.utils.AddressUtils;
import com.gy.common.utils.IpUtils;
import com.gy.common.utils.ServletUtils;
import com.gy.common.utils.StringUtils;
import com.gy.common.utils.spring.SpringContextHolder;
...
{
    // 配置织入点
    @Pointcut("@annotation(com.gy.common.log.annotation.OperLog)")
