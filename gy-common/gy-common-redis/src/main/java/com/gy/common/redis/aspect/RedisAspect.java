package com.gy.common.redis.aspect;
...
import com.gy.common.redis.annotation.RedisEvict;
...
public class RedisAspect
{
     ...
     */
    @Pointcut("@annotation(com.gy.common.redis.annotation.RedisCache)")
    public void redisCachePoint()
    {
    }

    @Pointcut("@annotation(com.gy.common.redis.annotation.RedisEvict)")
