 ...
 * @PackageName com.gy.gateway.config
 * @Description 
 * @Author daiz
...
public class SwaggerProvider implements SwaggerResourcesProvider
{
    ...
    public List<SwaggerResource> get()
    {
        ...
        gatewayProperties.getRoutes().stream().filter(routeDefinition -> routeDefinition.getId().equals("gy-system"))
